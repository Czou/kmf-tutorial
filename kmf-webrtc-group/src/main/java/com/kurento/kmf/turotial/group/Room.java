...
public class Room implements Closeable {
	...
	public Participant join(String userName, WebSocketSession session)
			throws IOException {
		log.info("ROOM {}: adding participant {}", userName, userName);
		final Participant participant = new Participant(userName, this.name, session,
				this.pipeline);
	...
	private void removeParticipant(String name) throws IOException {
		...
		final List<String> unnotifiedParticipants = newArrayListWithExpectedSize(participants
				.values().size());
